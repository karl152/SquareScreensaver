...
New-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\SquareScreensaver" -Name "DisplayVersion" -PropertyType String -Value "1.4" -Force
